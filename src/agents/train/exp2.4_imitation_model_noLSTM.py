...
checkpoint_path="/home/tianshuo/ray_results/exp2.5_imitation_run/PPO_Town03I3C2_measure_continuous-v0_0_2023-12-23_19-09-23qzqr2s5c/checkpoint_18400/checkpoint-18400"
# ray.init(num_cpus=30,memory=60*1024*1024*1024)

analysis = tune.run(
    "PPO",
    name="exp2.5_imitation_run",
    stop={
