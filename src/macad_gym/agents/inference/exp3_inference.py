...
checkpoint_path="/home/tianshuo/ray_results/exp2.5_imitation_4_Inte/PPO_Town03I4C2B1P4-v0_0_2023-12-15_12-37-55prfy_8_3/checkpoint_10450/checkpoint-10450"
    ...
    for ep in range(200):
        ...
        if (env._collisions["ego"].collision_vehicles > 0):
            print(env._collisions["car1"].collision_to_ego, env._collisions["car2"].collision_to_ego,
                  env._collisions["car3"].collision_to_ego)
