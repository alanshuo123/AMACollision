...
checkpoint_path="/home/tianshuo/ray_results/exp2.5_imitation_4_Inte/PPO_Town03I4C2B1P4-v0_0_2023-12-14_12-48-4770b47a_z/checkpoint_8150/checkpoint-8150"
# ray.init(num_cpus=30,memory=60*1024*1024*1024)

analysis = tune.run(
    "PPO",
    name="exp2.5_imitation_4_Inte",
    stop={
    ...
    config={
        ...
        "multiagent": {
            ...
            "policies_to_train": ["car1","car2", "car3","car4"],
        },
        "env_config": env_actor_configs,
        "num_workers": 1,
